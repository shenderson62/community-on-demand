...
const CareerAwareness = ({navigation}) => {
  ...
  for (const proj of projects) {
    if (proj.domainId.includes("Career Awareness")) {
  ...
  return (
    <DrawerScreen color='#07344B' header={
      <Fragment>
        <Text style={styles.welcomeText}>Career Awareness</Text>
        <Progress.Bar progress={progress[0] === undefined ? 0 : progress[0]["1"]} color='white' unfilledColor='#FAC33655' height={15} width={null} borderWidth={0} style={styles.progress}></Progress.Bar>
        <View style = {styles.progressHeader}>
          <Text style={styles.headerText}>{progress[0] === undefined ? 0 : progress[0]["1"] * 100}% competency of this skill</Text>
       </View>
       </Fragment>
    } image={
      <Image style={styles.image} source={require('../../assets/images/domain-icons/career-awareness.png')}></Image>
    } body={
      <View>
...
export default CareerAwareness;