...
const Innovation = ({navigation}) => {
  ...
  for (const proj of projects) {
    if (proj.domainId.includes("Innovation")) {
  ...
  return (
    <DrawerScreen color='#07344B' header={
      <Fragment>
        <Text style={styles.welcomeText}>Innovation</Text>
        <Progress.Bar progress={progress[0] === undefined ? 0 : progress[progress.length - 1]["2"]} color='white' unfilledColor='#FAC33655' height={15} width={null} borderWidth={0} style={styles.progress}></Progress.Bar>
        <View style = {styles.progressHeader}>
          <Text style={styles.headerText}>{progress[0] === undefined ? 0 : progress[progress.length - 1]["2"] * 100}% competency of this skill</Text>
       </View>
       </Fragment>
    } image={
      <Image style={styles.image} source={require('../../assets/images/domain-icons/innovation.png')}></Image>
    } body={
      <View>
