...
const WorkforceReady = ({navigation}) => {
  ...
  for (const proj of projects) {
    if (proj.domainId.includes("Workforce Ready")) {
  ...
  return (
    <DrawerScreen color='#07344B' header={
      <Fragment>
        <Text style={styles.welcomeText}>Workforce Ready</Text>
        <Progress.Bar progress={progress[0] === undefined ? 0 : progress[progress.length - 1]["5"]} color='white' unfilledColor='#FAC33655' height={15} width={null} borderWidth={0} style={styles.progress}></Progress.Bar>
        <View style = {styles.progressHeader}>
          <Text style={styles.headerText}>{progress[0] === undefined ? 0 : progress[progress.length - 1]["5"] * 100}% competency of this skill</Text>
       </View>
       </Fragment>
    } image={
      <Image style={styles.image} source={require('../../assets/images/domain-icons/workforce-ready.png')}></Image>
    } body={
      <View>
